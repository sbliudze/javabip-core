...
import org.bip.spec.telephonicNoAggr.AgregatorClient;
import org.bip.spec.telephonicNoAggr.Checker;
import org.bip.spec.telephonicNoAggr.Client;
import org.bip.spec.telephonicNoAggr.ClientCaller;
import org.bip.spec.telephonicNoAggr.DialWaitSync;
import org.bip.spec.telephonicNoAggr.DiscSync;
import org.bip.spec.telephonicNoAggr.DummyComponent;
import org.bip.spec.telephonicNoAggr.VoiceSync;
...
public class TelephonicNoAggrTest {
	...
	public void test5()
	{
		...
		ClientCaller dialWait = new DialWaitSync(n);
		ClientCaller voice = new VoiceSync(n);
		ClientCaller disc = new DiscSync(n);
		...
		client1.setExecutorRefs(actorDialWait, actorVoice, actorDisc,  actor1, checkerActor);
		client2.setExecutorRefs(actorDialWait, actorVoice, actorDisc,   actor2, checkerActor);
		client3.setExecutorRefs(actorDialWait, actorVoice, actorDisc,   actor3, checkerActor);
		client4.setExecutorRefs(actorDialWait, actorVoice, actorDisc,   actor4, checkerActor);
		client5.setExecutorRefs(actorDialWait, actorVoice, actorDisc,   actor5, checkerActor);
		
		
		dialWait = setClientRefs(clients, dialWait);
		voice = setClientRefs(clients, voice);
		disc = setClientRefs(clients, disc);
