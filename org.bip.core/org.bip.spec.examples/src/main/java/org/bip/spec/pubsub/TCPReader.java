...
//		this.connected = false;
	...
	// //TRANSITIONS
	//
	// behaviourBuilder.addTransitionAndStates("connect", initialState, connectingState,
	// "requiresConnection",
	...
	//
	// behaviourBuilder.addTransitionAndStates("subscribe", connectedState, subscribingState,
	...
	//
	// behaviourBuilder.addTransitionAndStates("publish", connectedState, publishingState,
	// "isInterestedInPublishing",
